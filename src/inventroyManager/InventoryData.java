...
public class InventoryData {
	...
	ItemsImplem anyItem = new ItemsImplem();
   ...
   // ArrayList that stores the inventory items
	private static ArrayList<ItemsImplem> items = new ArrayList<ItemsImplem>();
	 ...
	 */
	public ArrayList<ItemsImplem> setItems() {
		...
		for (ItemsImplem itemsObj : items) {
	 ...
	 */
	public boolean remove(ItemsImplem anyItem) {
	...
	public void removeItem() {
		...
		for (ItemsImplem item : items) {

			if (item.getId().equalsIgnoreCase(itemId))
				if (item instanceof BookItem books || item instanceof ElectronicItem electronics
						|| item instanceof GroceryItem groceries) {
					remove(item);
	 ...
	 */
	public static ArrayList<ItemsImplem> addItem(ItemsImplem anyItem) {
	 ...
	 */
	public ArrayList<ItemsImplem> getItems() {
	 ...
	 */
	public void viewItem(ItemsImplem anyItem) {
		...
		if (items.isEmpty()) {
			...
			for (ItemsImplem allItems : items) {
